...
Answer: SELECT name FROM country_club.Facilities where membercost > 0.0

/* Q2: How many facilities do not charge a fee to members? */

Answer: SELECT count(*) FROM country_club.Facilities where membercost = 0.0
...
Answer: SELECT facid,name,membercost,monthlymaintenance FROM country_club.Facilities where  membercost < (monthlymaintenance  * .2)
